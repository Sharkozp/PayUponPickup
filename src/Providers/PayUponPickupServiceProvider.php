...
class PayUponPickupServiceProvider extends ServiceProvider
{
     ...
     */
    public function boot(PayUponPickupHelper $paymentHelper, PaymentMethodContainer $payContainer,
                         Dispatcher $eventDispatcher)
    {
        ...
        $eventDispatcher->listen(ExecutePayment::class, function (ExecutePayment $event) use ($paymentHelper) {
            if ($event->getMop() == $paymentHelper->getPaymentMethod()) {
